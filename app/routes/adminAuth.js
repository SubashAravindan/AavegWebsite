...
router.get('/admin/events/:id/edit', adminAuthController.checkAdminLogin, adminAuthController.editEventForm)
...
router.put('/admin/events/:id', adminAuthController.checkAdminAccess, adminAuthController.editEventData)
